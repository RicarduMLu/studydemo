...
public class ArrayList<E> extends AbstractList<E>
    ...
    private class Itr implements Iterator<E> {
        ...
        public void forEachRemaining(Consumer<? super E> consumer) {
            ...
            final int size = utils.ArrayList.this.size;
            int i = cursor;
            if (i >= size) {
                return;
            }
            final Object[] elementData = utils.ArrayList.this.elementData;
            if (i >= elementData.length) {
                throw new ConcurrentModificationException();
            }
    ...
    private class ListItr extends ArrayList.Itr implements ListIterator<E> {
        ...
        public E previous() {
            ...
            Object[] elementData = utils.ArrayList.this.elementData;
            if (i >= elementData.length) {
                throw new ConcurrentModificationException();
            }
            cursor = i;
        ...
        public void set(E e) {
            ...
            try {
                utils.ArrayList.this.set(lastRet, e);
            } catch (IndexOutOfBoundsException ex) {
                throw new ConcurrentModificationException();
            }
        }
    ...
    public List<E> subList(int fromIndex, int toIndex) {
        ...
        return new utils.ArrayList.SubList(this, 0, fromIndex, toIndex);
    }
    ...
    private class SubList extends AbstractList<E> implements RandomAccess {
        ...
        SubList(AbstractList<E> parent,
            ...
            this.modCount = utils.ArrayList.this.modCount;
        }
        ...
        public E set(int index, E e) {
            rangeCheck(index);
            checkForComodification();
            E oldValue = utils.ArrayList.this.elementData(offset + index);
            utils.ArrayList.this.elementData[offset + index] = e;
            return oldValue;
        }
        ...
        public E get(int index) {
            rangeCheck(index);
            checkForComodification();
            return utils.ArrayList.this.elementData(offset + index);
        }
        ...
        public ListIterator<E> listIterator(final int index) {
            ...
            return new ListIterator<E>() {
                int cursor = index;
                int lastRet = -1;
                int expectedModCount = utils.ArrayList.this.modCount;
